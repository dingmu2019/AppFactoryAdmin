...
export const ProductCenterPage: React.FC = () => {
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5 col-span-2">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                           {t('products.form.selectApp')} <span className="text-rose-500">*</span>
                       </label>
                    ...
                    <div className="space-y-1.5 col-span-2">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                         {t('products.form.productName')} <span className="uppercase text-[10px] bg-slate-200 dark:bg-slate-700 px-1 rounded">{formLang}</span> <span className="text-rose-500">*</span>
                       </label>
                       <input 
                         type="text" 
                    ...
                    <div className="space-y-1.5">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                           {t('products.form.skuCode')} <span className="text-rose-500">*</span>
                       </label>
                       <input 
                         type="text" 
                    ...
                    <div className="space-y-1.5">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                           {t('products.form.selectCategory')} <span className="text-rose-500">*</span>
                       </label>
                       <select 
                    ...
                    <div className="space-y-1.5">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                           {t('products.form.selectType')} <span className="text-rose-500">*</span>
                       </label>
                       <select 
                    ...
                    <div className="space-y-1.5">
                       <label className="text-xs font-medium text-slate-500 dark:text-slate-400">
                           {t('products.form.status')} <span className="text-rose-500">*</span>
                       </label>
                       <select 
