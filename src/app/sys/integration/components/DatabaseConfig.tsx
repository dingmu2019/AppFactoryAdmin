    ...
    <div className="p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-zinc-900 dark:text-white">{t('integration.database.title')}</h2>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="space-y-6 bg-white dark:bg-zinc-900 rounded-lg">
        <div className="space-y-2">
            <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.type')}</label>
            <select
                value={formData.type}
        ...
        <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.host')}</label>
                <input
                    type="text"
                    value={formData.host}
            ...
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.port')}</label>
                <input
                    type="number"
                    value={formData.port}
        ...
        <div className="space-y-2">
            <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.database')}</label>
            <input
                type="text"
        ...
        <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.user')}</label>
                <input
                    type="text"
                    value={formData.user}
            ...
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.database.password')}</label>
