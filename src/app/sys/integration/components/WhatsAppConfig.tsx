    ...
    <div className="p-8 max-w-4xl mx-auto relative">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-zinc-900 dark:text-white">{t('integration.whatsapp.title')}</h2>
        </div>
        <div className="flex items-center gap-3">
      ...
      <div className="space-y-6 bg-white dark:bg-zinc-900 rounded-lg">
        <div className="space-y-4">
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.whatsapp.phoneNumberId')}</label>
                <input
                    type="text"
            ...
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.whatsapp.accountId')}</label>
                <input
                    type="text"
            ...
            <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700 dark:text-zinc-300">{t('integration.whatsapp.token')}</label>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-2xl w-full max-w-md overflow-hidden relative border border-zinc-200 dark:border-zinc-800 animate-in zoom-in-95 duration-200">
                <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex justify-between items-center">
                    <h3 className="font-bold text-lg text-zinc-900 dark:text-white">{t('integration.whatsapp.title')} - {t('common.test')}</h3>
                    <button onClick={() => setShowTestModal(false)} className="text-zinc-400 hover:text-zinc-600"><X size={20}/></button>
                </div>
                <div className="p-6 space-y-4">
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase">{t('integration.whatsapp.recipient')}</label>
                        <input 
                            type="text" 
                            value={testUser}
                        ...
                        />
                        <p className="text-xs text-zinc-400">{t('integration.whatsapp.hint.recipient')}</p>
                    </div>
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-zinc-500 uppercase">{t('integration.whatsapp.content')}</label>
                        <textarea 
                            value={testContent}
