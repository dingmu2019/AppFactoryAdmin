...
-- Function to revoke credits when an order is refunded
...
BEGIN
  ...
  -- 4. Record in Ledger (Negative TOPUP or new REVOKE kind)
  -- We use 'REVOKE' as a new kind to distinguish from consumption
  ...
  -- Note: Balance can go negative if user already spent them. This is intended.
