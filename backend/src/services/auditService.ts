...
// Use Service Role Key to bypass RLS for admin tasks
...
export class AuditLogService {
  ...
  static async query(params: AuditLogQueryDTO) {
    ...
    // if (user_email) query = query.ilike('user_email', `%${user_email}%`); // Removed
    if (params.user_id) query = query.eq('user_id', params.user_id); // Filter by user_id
