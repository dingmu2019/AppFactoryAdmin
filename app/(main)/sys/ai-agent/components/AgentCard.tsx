...
import { Bot, Edit2, Trash2, Power, MessageSquare } from 'lucide-react';
...
export const AgentCard: React.FC<AgentCardProps> = ({ agent, onEdit, onDelete, onToggleStatus }) => {
  ...
  return (
    <div className={`group relative bg-white dark:bg-slate-900 rounded-2xl border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${
      agent.is_active 
      ...
      <div className="p-6">
        ...
        <div className="flex items-start gap-4 mb-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-3xl shadow-lg shadow-indigo-500/20">
            {agent.avatar || '🤖'}
          </div>
